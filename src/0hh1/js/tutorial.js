...
var TutorialMessages = {
  1: { msg: 'Imos encher a grella.<br>Toca o azulexo para convertilo vermello.', tiles: [ [0,0,1] ] },
  2: { msg: 'Excelente!<br>Toca 2 veces para converter un azulexo en azul.', tiles: [ [0,1,2] ] },
  3: { msg: 'Non podes ter tres azulexos vermellos seguidos nunha fila.', tiles: [ [2,0,2] ] },
  4: { msg: 'Tampouco podes ter tres azulexos azuis seguidos nunha fila.', tiles: [ [1,1,1] ] },
  5: { msg: '¡Tampouco vale ter tres azulexos vermellos ou azuis na mesma columna!', tiles: [ [1,2,2], [2,2,1] ] },
  6: { msg: 'Unha fila completa debe ter a mesma cantidade de azulexos vermello que azuis.', tiles: [ [3,1,1] ], rows: [1] },
  7: { msg: 'As columnas deben ter a mesma cantidade de cada cor.', tiles: [ [1,3,2] ], cols: [1] },
  8: { msg: 'Xa case eres un experto! Xa sabes que cores son estas, verdade?', tiles: [ [2,3,1], [0,3,1] ] },
  9: { msg: 'Unha cousa...<br>As filas deben de ser todas diferentes', tiles: [ [0,2,2],[3,2,1] ], rows:[2,3] },
 10: { msg: 'Se quedas atascado, toca o ollo para botar unha ollada.', tiles: [ [3,0,2] ], wiggle: true }
}
