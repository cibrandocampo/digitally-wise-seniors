...
function renderBeginningText() {
	...
	if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
	    mob = true;
	    input_text = 'Toca nos lados esquerdo e dereito da pantalla';
	    action_text = 'para rotar o hexágono';
	    score_text = 'Emparella 3 ou máis bloques para obter puntos';
	    fontSize = 35;
	} else {
	    mob = false;
	    input_text = 'Usa as teclas de frecha dereita e esquerda';
	    action_text = 'para rotar o hexágono';
	    score_text = 'Emparella 3 ou máis bloques para obter puntos!';
	    fontSize = 27;
	}
